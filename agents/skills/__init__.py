...
# Update: 2025-12-17 - 添加代码工厂 Skills (v2.0)
"""
...
# =============================================================================
# 代码工厂 Skills v2.0 (2025-12-17)
# 架构: SEARCH → SELECT → ADAPT → ASSEMBLE → VERIFY
# =============================================================================
...
from .code_factory_skill import CodeFactorySkill, code_factory_skill, FactoryConfig
...
__all__ = [
    ...
    # 代码工厂 Skills v2.0
    # =============================================================================
    # 搜索 Skill (来源: code-graph-rag, Aider)
    'CodeSearcherSkill',
    'code_searcher_skill',
    # 选型 Skill (来源: MetaGPT, Devika)
    'CodeSelectorSkill',
    'code_selector_skill',
    # 适配 Skill (来源: astx, refactor)
    'CodeAdapterSkill',
    'code_adapter_skill',
    # 组装 Skill (来源: Aider, Copier)
    'CodeAssemblerSkill',
    'code_assembler_skill',
    # 验证 Skill (来源: mypy, ruff)
    'CodeVerifierSkill',
    'code_verifier_skill',
    # 主编排器 (来源: MetaGPT, OpenHands, SWE-agent)
    'CodeFactorySkill',
    'code_factory_skill',
    'FactoryConfig',
]
