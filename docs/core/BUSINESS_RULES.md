...
|---------|---------|-------------|-------|------|
| **BR-AUTH** | 认证与授权 | [docs/core/rules/BR-AUTH.md](./rules/BR-AUTH.md) | P0 | ✅ 已定义 |
| **BR-USER** | 用户与角色 | [docs/core/rules/BR-USER.md](./rules/BR-USER.md) | P0 | ✅ 已定义 |
| **BR-PROJ** | 项目管理 | [docs/core/rules/BR-PROJ.md](./rules/BR-PROJ.md) | P1 | ✅ 已定义 |
| **BR-CHAN** | 渠道管理 | [docs/core/rules/BR-CHAN.md](./rules/BR-CHAN.md) | P1 | ✅ 已定义 |
| **BR-ACCT** | 广告账户 | [docs/core/rules/BR-ACCT.md](./rules/BR-ACCT.md) | P1 | ✅ 已定义 |
| **BR-FIN** | 财务流程 | [docs/core/rules/BR-FIN.md](./rules/BR-FIN.md) | P0 | ✅ 已定义 |
| **BR-RECON** | 对账流程 | [docs/core/rules/BR-RECON.md](./rules/BR-RECON.md) | P1 | ✅ 已定义 |
| **BR-RPT** | 日报管理 | [docs/core/rules/BR-RPT.md](./rules/BR-RPT.md) | P1 | ✅ 已定义 |
| **BR-DATA** | 数据完整性 | [docs/core/rules/BR-DATA.md](./rules/BR-DATA.md) | P0 | ✅ 已定义 |
...
**查看详情**: [docs/core/rules/BR-AUTH.md](./rules/BR-AUTH.md)
...
**查看详情**: [docs/core/rules/BR-USER.md](./rules/BR-USER.md)
...
**查看详情**: [docs/core/rules/BR-PROJ.md](./rules/BR-PROJ.md)
...
**查看详情**: [docs/core/rules/BR-CHAN.md](./rules/BR-CHAN.md)
...
**查看详情**: [docs/core/rules/BR-ACCT.md](./rules/BR-ACCT.md)
...
**查看详情**: [docs/core/rules/BR-FIN.md](./rules/BR-FIN.md)
...
**查看详情**: [docs/core/rules/BR-RECON.md](./rules/BR-RECON.md)
...
**查看详情**: [docs/core/rules/BR-RPT.md](./rules/BR-RPT.md)
...
**查看详情**: [docs/core/rules/BR-DATA.md](./rules/BR-DATA.md)
...
**必须引用的SoT文档**:
- **AI_AD_SYSTEM_MASTER_SPEC_v2.2.md** - 架构设计与技术决策
...
**引用格式示例**:
```markdown
**引用**: `AI_AD_SYSTEM_MASTER_SPEC_v2.2.md` 第3.2.5节 - Ledger双账本规范
**引用**: `STATE_MACHINE.md` v2.6 第8章 - 粉数确认状态机
**引用**: `DATA_SCHEMA.md` 3.3.1 - `daily_reports` 表
**引用**: `ERROR_CODES.md` - STATE_400, TREND_001
```
...
```
业务规则索引 (本文档)
    ├─→ 规则子模块      (docs/core/rules/BR-*.md)   - 规则详细定义
    ├─→ 数据模型 SoT    (DATA_SCHEMA.md)            - 数据约束基础
    ├─→ 状态机 SoT      (STATE_MACHINE.md)          - 状态流转规则
    ├─→ 权限策略 SoT    (RLS_POLICIES.md)           - 权限控制规则
    ├─→ 错误码 SoT      (ERROR_CODES.md)            - 错误码映射基础
    └─→ 主设计文档      (AI_AD_SYSTEM_MASTER_SPEC_v2.2.md) - 系统架构设计
```
