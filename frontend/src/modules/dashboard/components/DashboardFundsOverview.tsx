  ...
  return (
    <Card className={cn('rounded-lg border-default bg-card-bg hover:shadow-lg transition-shadow', className)}>
      ...
      <CardContent className="space-y-4">
        {/* 总余额卡片 */}
        <div className="p-4 bg-elevated border border-default rounded-lg hover:shadow-md transition-shadow">
          ...
          <div className="mt-2">
            <Progress
              ...
              className="h-1 bg-card-bg [&>div]:bg-success"
            />
        ...
        <div className="p-4 bg-elevated border border-default rounded-lg hover:shadow-md transition-shadow">
          ...
          {onTopupClick && (
            <Button
              ...
              className="w-full mt-3 text-xs border-border-default text-text-body hover:bg-elevated hover:text-text-strong"
            >
              查看详情
            </Button>
          )}
