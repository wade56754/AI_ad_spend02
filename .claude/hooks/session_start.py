...
def main():
    ...
    print("📚 SoT 文档优先级顺序：")
    print("  1. docs/1.overview/MASTER.md v4.4 - 系统全局规则")
    print("  2. docs/1.overview/BUSINESS_FLOW_MANAGEMENT.md - 业务流程管理")
    print("  3. docs/1.overview/MVP_PHASE_DESIGN.md - MVP 阶段设计")
    print("  4. docs/2.sot/STATE_MACHINE.md v2.6 - 状态机规范")
    print("  5. docs/2.sot/DATA_SCHEMA.md v5.2 - 数据模型")
    print("  6. docs/2.sot/LEDGER_SOT.md v1.1 - 账本规则")
    print("  7. docs/2.sot/BUSINESS_RULES.md v3.2 - 业务规则")
    print("  8. docs/2.sot/API_SOT.md v9.0 - API 规范")
    print("  9. docs/2.sot/ERROR_CODES_SOT.md v2.1 - 错误码")
    print(" 10. docs/2.sot/AUTH_SPEC.md v2.0 - 认证授权")
    print()
