            ...
            {tasks.map((task) => (
              <div
                ...
                className={cn(
                  ...
                  'hover:bg-elevated rounded-lg transition-all',
                  'border border-transparent hover:border-border-muted',
              ...
              >
                <div className="flex items-center gap-3 flex-1 min-w-0">
                  ...
                  <div
                    className={cn(
                      'w-2 h-2 rounded-full ring-2 ring-offset-2 ring-offset-card-bg shrink-0',
