...
> **对齐基准**: AI_AD_SYSTEM_MASTER_SPEC_v2.2.md + BRD_chapter1_v3.1.md
...
| **财务对账流程** | 月度对账批次3日内完成 | draft→submitted→confirmed |
...
```
AI_AD_SYSTEM_MASTER_SPEC_v2.2.md (本文档的技术详解版)
    │
...
3. 阅读AI_AD_SYSTEM_MASTER_SPEC_v2.2.md 第1-6章 - 技术细节
4. 查阅对应模块的详细文档
...
2. 阅读AI_AD_SYSTEM_MASTER_SPEC_v2.2.md - 技术规范
3. 查阅DATA_SCHEMA.md、STATE_MACHINE.md、ERROR_CODES.md - 实现细节
...
**文档状态**: ✅ 已完成 - 与 AI_AD_SYSTEM_MASTER_SPEC_v2.2.md 完全对齐
