...
export function useProfitSummary(
  ...
  return useQuery({
    queryKey: queryKeys.financeProfit.summary(params),
...
export function useProfitByProject(
  ...
  return useQuery({
    queryKey: queryKeys.financeProfit.byProject(params),
...
export function useProfitByAccount(
  ...
  return useQuery({
    queryKey: queryKeys.financeProfit.byAccount(params),
...
export function useProfitByChannel(
  ...
  return useQuery({
    queryKey: queryKeys.financeProfit.byChannel(params),
...
export function useProfitTrend(
  ...
  return useQuery({
    queryKey: queryKeys.financeProfit.trend(params),
