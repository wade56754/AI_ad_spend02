...
> **架构决策（MASTER v4.6+）变更**: 日报审核人由原 supervisor 变更为 project_owner
...
> **架构决策（MASTER v4.6+）变更**: real 数据提交者由原 supervisor 变更为 project_owner
...
> **架构决策（MASTER v4.6+）变更**: final 数据提交者由原 supervisor 变更为 project_owner
