...
const mockSummary = {
  total_cost: 125680.50,
  media_cost: 98500.00,
  service_fee: 15680.50,
  other_cost: 11500.00,
};

const mockBreakdown = [
  { category: '媒体消耗', amount: 98500, percentage: 78.4, trend: 5.2 },
  { category: '服务费', amount: 15680.50, percentage: 12.5, trend: -2.1 },
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b">
                  ...
                  <th className="text-right py-3 px-4 font-medium text-gray-600">环比变化</th>
                </tr>
              </thead>
              <tbody>
                  ...
                  <tr key={index} className="border-b hover:bg-gray-50">
                    ...
                    <td className="text-right py-3 px-4">
                      <span className={`flex items-center justify-end gap-1 ${
                        item.trend > 0 ? 'text-red-600' : item.trend < 0 ? 'text-green-600' : 'text-gray-600'
                      }`}>
                        {item.trend > 0 ? (
