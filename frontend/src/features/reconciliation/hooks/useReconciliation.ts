...
export function useReconciliationMismatches(
  ...
  return useQuery({
    queryKey: [...queryKeys.reconciliation.detail(reconciliationId), 'mismatches'],
...
export function useReconciliationsByProject(
  ...
  return useQuery({
    queryKey: queryKeys.reconciliation.byProject(projectId, params as Record<string, unknown>),
...
export function useLatestReconciliation(
  ...
  return useQuery({
    queryKey: [...queryKeys.reconciliation.all, 'latest', projectId],
...
export function useReconciliationStats(
  ...
  return useQuery({
    queryKey: [...queryKeys.reconciliation.all, 'stats', params],
...
export function useRunReconciliation(
  ...
  return useMutation({
    ...
    onSuccess: (data, id) => {
      queryClient.setQueryData(queryKeys.reconciliation.detail(id), data);
      queryClient.invalidateQueries({ queryKey: queryKeys.reconciliation.lists() });
    },
    ...options,
  });
}
...
export function useResolveMismatch(
  ...
  return useMutation({
    ...
    onSuccess: (_, { reconciliationId }) => {
      ...
      queryClient.invalidateQueries({
        queryKey: queryKeys.reconciliation.detail(reconciliationId),
      });
    },
    ...options,
  });
